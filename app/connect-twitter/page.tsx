              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                  ...
                  <ul className="text-xs text-yellow-700 dark:text-yellow-300 space-y-1 list-disc list-inside">
                    <li>Ensure TWITTER_CLIENT_ID and TWITTER_CLIENT_SECRET are set in .env.local</li>
                    <li>Verify the callback URL matches exactly in your Twitter app settings</li>
                    <li>Check that the twitter_accounts table exists in Supabase</li>
                    <li>Make sure your Twitter app has the required scopes enabled</li>
                  </ul>
                </div>
              </div>
            )}
...
function getErrorMessage(error: string, searchParams: URLSearchParams): string {
  ...
  const errorMessages: Record<string, string> = {
    ...
    storage_failed_table_missing: "The twitter_accounts table does not exist. Please run the SQL migration in Supabase to create the table.",
    storage_failed_permission_denied: "Permission denied. Please check your Row Level Security (RLS) policies for the twitter_accounts table. Ensure the INSERT and UPDATE policies allow authenticated users to modify their own records.",
    callback_failed: "An error occurred during authentication. Please try again.",
    oauth_init_failed: "Failed to initiate Twitter connection. Please check your TWITTER_CLIENT_ID environment variable.",
  };
